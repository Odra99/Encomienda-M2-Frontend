...
import {  Ingreso } from 'src/app/data/model/general';
...
export class IngresoService {
  ...
  baseUrl = environment.encomiendaBackendUrl + 'ingreso';
  constructor(
  ...
  save(entity: Ingreso): Observable<any> {
    this.getUrl();
  ...
  getUrl(){
    this.baseUrl = this.predectibleModule.getUrl() + 'ingreso';
  }
}
